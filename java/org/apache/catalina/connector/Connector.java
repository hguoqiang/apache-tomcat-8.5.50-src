...
public class Connector extends LifecycleMBeanBase {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        //实例化 CoyoteAdapter ，主要作用是 把 客户端请求 转换成 ServletRequest
        ...
        try {
            //protocolHandler 是 Coyote 协议接⼝， 通过Endpoint 和 Processor ， 实现针对具体协议的处理能⼒。
            //Tomcat 按照协议和I/O 提供了6个实现类 ： AjpNioProtocol ，AjpAprProtocol， AjpNio2Protocol ，
